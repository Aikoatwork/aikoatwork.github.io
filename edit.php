...
<body>
    ...
    $query=mysqli_query($konek, "SELECT * from member where
                        id_member=$id_member");
            ...
            <div class="card">
                <div class="card-body">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" name="id_member" id="id_member" readonly value="<?php echo $data['id_member'];?>">
                        </div>
                        <div class="mb-1">
                        ...
                        <div class="mb-1">
                            <label for="kota">Cabang Kota</label>
                            <input type="text" class="form-control" name="kota" id="kota" value="<?php echo $data['kota'];?>">
                        </div>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>NOPLAYERINGAME</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
